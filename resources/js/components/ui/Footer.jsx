    ...
    <footer className="bg-blue-600 text-white py-10 mt-20 border-t border-green-200">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-start md:items-center">
        ...
        <div className="flex flex-col md:flex-row gap-3 md:gap-6 text-sm font-medium">
          ...
          <a href="#" className="hover:text-blue-300 transition">Fitur</a>
          <a href="#" className="hover:text-blue-300 transition">Laporan</a>
          <a href="#" className="hover:text-blue-300 transition">Kontak</a>
          <a href="#" className="hover:text-blue-300 transition">Legal</a>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between text-xs text-white">
        <div className="flex flex-wrap gap-3 mb-2 md:mb-0">
          <a href="#" className="hover:text-blue-300 transition">Terms & Conditions</a>
          <a href="#" className="hover:text-blue-300 transition">Privacy Policy</a>
          <a href="#" className="hover:text-blue-300 transition">Accessibility</a>
          <a href="#" className="hover:text-blue-300 transition">Legal</a>
        </div>
