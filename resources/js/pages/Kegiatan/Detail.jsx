                            ...
                            <div className="space-y-5">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="w-full">
                                        <p className="text-xs text-gray-500 font-bold uppercase tracking-wide mb-1">Rincian / Deskripsi</p>
                                    ...
                                    {kegiatan.dokumentasi_urls.map((url, idx) => (
                                        <div key={idx} className="relative group cursor-pointer" onClick={() => setSelectedNota(url)}>
                                            <img 
                                                ...
                                                onError={(e) => { e.target.src = "https://placehold.co/600x400?text=Gagal"; }}
                                            />
                                            {/* Overlay icon zoom */}
