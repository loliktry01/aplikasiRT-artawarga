...
export default function Detail({ kegiatan, totalPengeluaran, listPengeluaran = [], canAddExpense, sisaBop, sisaIuran }) {
    ...
    // ==========================================
    // 💡 LOGIKA PERHITUNGAN MULTI-SUMBER DANA (Tidak Berubah)
    // ==========================================
    let usedBop = 0;
    let usedIuran = 0;
        ...
        <AppLayout>
            ...
            <div className="space-y-8 p-4 md:p-0">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 mb-2">RINCIAN KEGIATAN</h1>
                        <Breadcrumbs
                            items={[
                    ...
                    <div className="flex gap-3">
                        {/* REVISI AKHIR: Button Download PDF dengan warna VIOLET */}
                        {listPengeluaran.length > 0 && (
                            <Button
                                onClick={() => handleDownload(kegiatan.id)} // Menggunakan kegiatan.id yang benar
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div className="bg-white border rounded-2xl p-6 shadow-sm">
                            <div className="flex justify-between items-start mb-4">
                                <h2 className="text-xl font-bold text-gray-800">{kegiatan.nm_keg}</h2>
                                {listPengeluaran.length > 0 ? (
                            ...
                            <div className="space-y-5">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p className="text-xs text-gray-500 font-bold uppercase tracking-wide">Waktu Pelaksanaan</p>
                                ...
                                {/* [PERUBAHAN]
                                    Bagian Deskripsi (ikon FileText) telah DIHAPUS sesuai permintaan.
                                */}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white border rounded-2xl p-6 shadow-sm h-full flex flex-col">
                            <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-4">
                                Dokumentasi ({kegiatan.dokumentasi_urls?.length || 0})
                            </h3>
                ...
                <div className="pt-6 border-t border-gray-200">
                    ...
                    {listPengeluaran.length > 0 ? (
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                                ...
                                <Card className="rounded-2xl border-none shadow-md bg-white overflow-hidden relative">
                                    ...
                                    <CardContent className="p-5">
                                        <div className="flex justify-between items-start mb-4">
                                            <div className="p-2 rounded-lg bg-orange-100 text-orange-600"><PiggyBank className="w-5 h-5"/></div>
                                        </div>
                                        ...
                                        <div className="mt-2 text-xs text-gray-400">
                                            {usedBop > 0 && <span>BOP: {formatRupiah(initialBopSnapshot)}<br/></span>}
                                            {usedIuran > 0 && <span>Iuran: {formatRupiah(initialIuranSnapshot)}</span>}
                                        </div>
                                    </CardContent>
                                </Card>
                                ...
                                <Card className="rounded-2xl border-none shadow-md bg-white overflow-hidden relative">
                                    ...
                                    <CardContent className="p-5">
                                        <div className="flex justify-between items-start mb-4">
                                            <div className="p-2 rounded-lg bg-pink-100 text-pink-600"><ArrowDownCircle className="w-5 h-5"/></div>
                                        </div>
                                        ...
                                        <div className="mt-2 text-xs text-pink-400">
                                            {usedBop > 0 && <span>BOP: {formatRupiah(usedBop)}<br/></span>}
                                            {usedIuran > 0 && <span>Iuran: {formatRupiah(usedIuran)}</span>}
                                        </div>
                                    </CardContent>
                                </Card>
                                ...
                                <Card className="rounded-2xl border-none shadow-md bg-white overflow-hidden relative">
                                    ...
                                    <CardContent className="p-5">
                                        ...
                                        <div className="mt-2 text-xs text-emerald-600/70">
                                            {usedBop > 0 && <span>BOP: {formatRupiah(sisaBop)}<br/></span>}
                                            {usedIuran > 0 && <span>Iuran: {formatRupiah(sisaIuran)}</span>}
                                        </div>
                                    </CardContent>
                                </Card>
                                ...
                                <Card className="rounded-2xl border-none shadow-md bg-white overflow-hidden relative">
                                    ...
                                    <CardContent className="p-5">
                                        <div className="flex justify-between items-start mb-4">
                                            <div className="p-2 rounded-lg bg-blue-100 text-blue-600"><Coins className="w-5 h-5"/></div>
                                        </div>
                            ...
                            {/* DAFTAR TRANSAKSI (UPDATED: PENERIMA) */}
                            <div className="space-y-4">
                                <h3 className="text-lg font-bold text-gray-800">Daftar Transaksi ({listPengeluaran.length})</h3>
                                    ...
                                    <div key={item.id} className="bg-white border rounded-2xl shadow-sm p-6 hover:shadow-md transition-shadow relative overflow-hidden">
                                        ...
                                        <div className="flex flex-col md:flex-row gap-6 mt-2">
                                            ...
                                            <div className="flex-grow grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8 text-sm">
                                                ...
                                                <div>
                                                    <p className="text-xs text-gray-400 font-bold uppercase mb-1">Tanggal Transaksi</p>
                                                    <p className="font-medium text-gray-900 text-base">{formatDate(item.tgl)}</p>
                                                </div>
                                                <div>
                        ...
                        <div className="bg-white border-2 border-dashed border-gray-300 rounded-2xl p-12 text-center shadow-sm flex flex-col items-center justify-center">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-2">Belum Ada Laporan Keuangan</h3>
                            ...
                            {canAddExpense && (
                                <div className="flex flex-col items-center">
                                    ...
                                    <p className="text-xs text-gray-400 mt-3 bg-gray-50 px-3 py-1 rounded-full">
                                        *Arahkan ke Dashboard &gt; Tambah Pengeluaran &gt; Pilih Kegiatan ini
                                    </p>
                                </div>
                            )}
                        </div>
